...
export default class OrdersApi {
    ...
    */
     ...
     */
    calculateOrder(id, qty, callback) {
      let postBody = null;
     ...
     * @callback module:api/OrdersApi~couponValidCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/OrdersApi~couponValidCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * data is of type: {@link 'String'}
     */
    createOrder(customerName, customerSurname, customerPhone, customerEmail, deliveryName, deliverySurname, deliveryPhone, id, qty, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        '_channel_code': opts['channelCode'],
    ...
    /**
     * Callback function to receive the result of the orderDetails operation.
     * @callback module:api/OrdersApi~orderDetailsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/OrdersApi~orderDetailsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Order}
     */
    orderDetails(tokenValue, callback) {
      let postBody = null;
