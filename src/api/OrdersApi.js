...
export default class OrdersApi {
    ...
    */
     ...
     */
    orderCreate(customerName, customerSurname, customerPhone, customerEmail, deliveryName, deliverySurname, deliveryPhone, id, qty, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'participant_attributes[]': this.apiClient.buildCollectionParam(opts['participantAttributes'], 'multi'),
