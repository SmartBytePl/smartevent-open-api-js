...
export default class CategoriesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the categoriesCodeGet operation.
     * @callback module:api/CategoriesApi~categoriesCodeGetCallback
     ...
     * @param {module:api/CategoriesApi~categoriesCodeGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Category}
     */
    categoriesCodeGet(code, callback) {
      let postBody = null;
