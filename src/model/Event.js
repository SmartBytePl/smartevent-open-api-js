...
export default class Event {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('visible_from')) {
                obj['visible_from'] = ApiClient.convertToType(data['visible_from'], 'String');
            }
            if (data.hasOwnProperty('visible_until')) {
                obj['visible_until'] = ApiClient.convertToType(data['visible_until'], 'String');
            }
    ...
    */
    end_date = undefined;
    /**
    * @member {String} visible_from
    */
    visible_from = undefined;
    /**
    * @member {String} visible_until
    */
    visible_until = undefined;
    /**
    * Keys reference to locale of a translation
    * @member {Object.<String, Array.<module:model/TranslationEvent>>} translations
    */
