...
export default class Ticket {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('alternative_on_hand')) {
                obj['alternative_on_hand'] = ApiClient.convertToType(data['alternative_on_hand'], 'String');
            }
    ...
    */
    on_hand = undefined;
    /**
    * Alternative number of available tickets it is used to show specific value for the user
    * @member {String} alternative_on_hand
    */
    alternative_on_hand = undefined;
    /**
